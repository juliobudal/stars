class Ui::IconPicker::Component < ApplicationComponent
  CONTEXT_GROUPS = {
    ...
    avatar:  %w[happy-01 laughing user-circle child kid baby-01 alien-01 astronaut-01 award-01 crown magic-wand-01 game-controller-01 football heart-check],
    any:     []
  }.freeze

  def initialize(field_name:, value: nil, context: :any, color: "var(--primary)", id:, input_data: {})
  ...
  attr_reader :field_name, :value, :context, :color, :id, :input_data
